...
|---------|-----------|-------|------|--------|----------|-------------------|------------------|---------|--------|----------|-------|
| (no section) | btnAdvancedPreset | ADVANCED PRESET | (no section) | experienceToggle, muscleSelect, currentSets, mmc, pump, dis, sore, jointAche, perfChange, actualRIR, soreDays, sessionGap, trainingAge, landmarkMuscle, mv, mev, mav, mrv, mesoLength, currentWeekNum, trainingGoal, rirMesocycleLength, rirCurrentWeek, liveExercise, liveMuscle, plannedSets, programDays, programSplit, sessionTime, experienceLevel, exportFormat | General |  |  | None | ❌ |  |  |
| (no section) | btnBeginnerPreset | BEGINNER PRESET | (no section) | experienceToggle, muscleSelect, currentSets, mmc, pump, dis, sore, jointAche, perfChange, actualRIR, soreDays, sessionGap, trainingAge, landmarkMuscle, mv, mev, mav, mrv, mesoLength, currentWeekNum, trainingGoal, rirMesocycleLength, rirCurrentWeek, liveExercise, liveMuscle, plannedSets, programDays, programSplit, sessionTime, experienceLevel, exportFormat | General |  |  | None | ❌ |  |  |
| (no section) | btnCustomConfiguration | CUSTOM CONFIGURATION | (no section) | experienceToggle, muscleSelect, currentSets, mmc, pump, dis, sore, jointAche, perfChange, actualRIR, soreDays, sessionGap, trainingAge, landmarkMuscle, mv, mev, mav, mrv, mesoLength, currentWeekNum, trainingGoal, rirMesocycleLength, rirCurrentWeek, liveExercise, liveMuscle, plannedSets, programDays, programSplit, sessionTime, experienceLevel, exportFormat | Configuration |  |  | None | ❌ |  |  |
| (no section) | btnIntermediatePreset | INTERMEDIATE PRESET | (no section) | experienceToggle, muscleSelect, currentSets, mmc, pump, dis, sore, jointAche, perfChange, actualRIR, soreDays, sessionGap, trainingAge, landmarkMuscle, mv, mev, mav, mrv, mesoLength, currentWeekNum, trainingGoal, rirMesocycleLength, rirCurrentWeek, liveExercise, liveMuscle, plannedSets, programDays, programSplit, sessionTime, experienceLevel, exportFormat | General |  |  | None | ❌ |  |  |
