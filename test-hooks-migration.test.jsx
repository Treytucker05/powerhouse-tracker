...
describe('Algorithm Hooks Migration Validation', () => {
    describe('useVolumeAlgorithms', () => {
        ...
        it('should calculate stimulus correctly', () => {
            ...
            const stimulus = result.current.scoreStimulus({ mmc: 2, pump: 2, disruption: 2 });

            expect(stimulus).toHaveProperty('score', 6);
        ...
        it('should generate volume progression correctly', () => {
            ...
            expect(progression).toEqual({
                ...
                weeksPlan: 4,
                progression: [
                    { week: 1, volume: 13, increment: 3 },
                    { week: 2, volume: 15, increment: 3 },
                    { week: 3, volume: 18, increment: 3 },
                    { week: 4, volume: 20, increment: 3 }
                ]
            });
        });
    });
