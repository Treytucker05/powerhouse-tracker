...
null == a &&
  (((a = function (e) {
    ...
    if (e in n) {
      ...
      delete n[e];
      var l = { id: e, exports: {} };
      return (t[e] = l), a.call(l.exports, l, l.exports), l.exports;
    }
...
(window.trainingState = u.default),
  (window.updateChart = l.updateChart),
  (window.resetWeeklyData = l.resetChart),
  (window.showVolumeLandmarks = l.addVolumeLandmarks),
  (window.exportSummary = l.exportChartImage),
  (window.toggleSection = function (e) {
    ...
    n.classList.toggle("expanded", l),
      a && (a.style.transform = l ? "rotate(180deg)" : "rotate(0deg)");
    let s = () => {
      let e = Math.max(
    ...
    s(), t.addEventListener("transitionend", s, { once: !0 });
  }),
  (window.scoreStimulus = s.scoreStimulus),
  (window.setProgressionAlgorithm = s.setProgressionAlgorithm),
  (window.getVolumeProgression = s.getVolumeProgression),
  (window.analyzeDeloadNeed = s.analyzeDeloadNeed),
  (window.calculateTargetRIR = o.calculateTargetRIR),
  (window.validateEffortLevel = o.validateEffortLevel),
  (window.analyzeFrequency = d.analyzeFrequency),
  (window.calculateOptimalFrequency = d.calculateOptimalFrequency),
  ...
  (window.submitFeedback = function () {
    let e = document.getElementById("muscleSelect").value,
      ...
      d = parseInt(document.getElementById("sore").value, 10),
    ...
    let m = (0, s.scoreStimulus)({ mmc: t, pump: n, disruption: a }),
      g = (0, s.setProgressionAlgorithm)(d, c),
      v = (0, s.getVolumeProgression)(e, {
      ...
      p = null;
    r && (p = (0, o.validateEffortLevel)(parseFloat(r))),
  ...
  (window.analyzeDeload = function () {
    let e = document.getElementById("halfMuscles").checked,
      ...
      o = (0, s.analyzeDeloadNeed)();
    e && o.reasons.push("Most muscles need recovery (manual check)"),
      t && o.reasons.push("Hit MRV twice consecutively (manual check)"),
      n && o.reasons.push("Illness/injury present"),
      a && o.reasons.push("Low motivation levels");
    let d = o.shouldDeload || e || t || n || a,
    ...
    `),
        ...
        setTimeout(() => {
          ...
          ) && (u.default.startDeload(), (0, l.updateChart)());
        }, 1e3))
  ...
  (window.analyzeFrequency = function () {
    let e = parseInt(document.getElementById("soreDays").value, 10),
      ...
      l = (0, d.analyzeFrequency)(e, t, a),
      s = (0, d.calculateOptimalFrequency)(a, {
        trainingAge: n,
        currentVolume: u.default.currentWeekSets[a],
      }),
      o = document.getElementById("freqOut");
    o.innerHTML = `
  ...
  `;
    let r =
      "high" === l.urgency || "medium" === l.urgency ? "warning" : "success";
    o.className = `result ${r} active`;
  }),
  (window.saveLandmarks = function () {
    let e = document.getElementById("landmarkMuscle").value,
      ...
      s = parseInt(document.getElementById("mrv").value, 10);
    if (t > n || n > a || a > s)
      return void alert("Invalid landmark relationship (MV ≤ MEV ≤ MAV ≤ MRV)");
    u.default.updateVolumeLandmarks(e, { MV: t, MEV: n, MAV: a, MRV: s }),
      (0, l.updateChart)();
    let o = document.getElementById("volumeOut");
    (o.innerHTML = `Landmarks saved for ${e}: MV:${t}, MEV:${n}, MAV:${a}, MRV:${s}`),
      (o.className = "result success active");
  }),
  ...
  (window.setupMeso = function () {
    ...
    let l = document.getElementById("mesoOut");
    (l.innerHTML = `
...
//# sourceMappingURL=ProgramDesignWorkspace.299d1eaa.js.map
