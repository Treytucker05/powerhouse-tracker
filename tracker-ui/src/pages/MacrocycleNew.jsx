...
export default function Macrocycle() {
  console.log('🔵 New Macrocycle loaded');
            ...
            <div className="mb-8">
              ...
              {location.state?.programData && (
                <div className="bg-gray-800 rounded-lg p-4 border border-gray-700 mt-4">
                  <h3 className="text-xl font-semibold text-white mb-2">{location.state.programData.name}</h3>
                  <div className="flex items-center space-x-6 text-sm text-gray-300">
                    <span>Goal: <span className="text-red-400 capitalize">{location.state.programData.goal}</span></span>
                    <span>Duration: <span className="text-red-400">{location.state.programData.duration} weeks</span></span>
                    <span>Training Days: <span className="text-red-400">{location.state.programData.trainingDays}/week</span></span>
                  </div>
                </div>
              )}
            </div>
