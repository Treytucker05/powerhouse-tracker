...
const StreamlinedProgramNavigation = () => {
    ...
    // Get current methodology-specific tabs
    const currentMethodologyTabs = getMethodologySpecificTabs(state.selectedSystem);
    ...
    const allTabs = [
        ...
        // PHASE 3: Assessments (methodology-specific + injury screening)
        ...currentMethodologyTabs,
        ...streamlinedTabs.filter(tab => tab.phase === 'Assessments' && tab.step === 6),

        // PHASE 4: Program Design
        ...streamlinedTabs.filter(tab => tab.phase === 'Program Design')
    ];
        ...
        <div className="program-navigation">
            <div className="workflow-header">
                <h1 className="text-2xl font-bold text-white mb-4">
                    🏛️ PowerHouseATX Program Design - Methodology First
                </h1>
        ...
        switch (state.currentStep) {
            ...
            case 5:
                if (state.selectedSystem === 'josh-bryant') {
                    ...
                    return <MovementAssessmentStep />; // Can be enhanced with NASM-specific component
                }
