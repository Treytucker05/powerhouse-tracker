...
import PHAHealthStep from './PHAHealthStep';
...
const StepWizard = ({ setUserProfile }) => {
    ...
    // PHA Test Function
    const runPHATest = () => {
        console.log('🧪 Running PHA Health Screening Tests...');
    ...
    const canProceed = () => {
        switch (currentStep) {
            ...
            case 4: return true; // PHA Health - optional, always can proceed  
            case 5: return true; // Gainer type - optional, always can proceed
            case 6: return true; // SMART goals - optional, always can proceed
            case 7: return true; // Volume landmarks - optional, always can proceed
            case 8: return true; // Final step, always can proceed to submit
    ...
    const renderCurrentStep = () => {
        switch (currentStep) {
            ...
            case 4:
                return <PHAHealthStep assessmentData={assessmentData} onInputChange={handleInputChange} />;
            case 5:
        ...
        <div className="space-y-6">
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm text-blue-400 font-medium">Step {currentStep + 1} of 9</span>
                </div>
                ...
                <p className="text-xs text-gray-500 mt-2">
                    {currentStep === 8 ? 'Ready to submit your complete assessment!' : 'Complete all steps for your personalized program design'}
                </p>
            </div>
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
                <h4 className="text-white font-medium mb-2">Comprehensive Assessment Steps:</h4>
                <ul className="text-gray-300 text-sm space-y-1">
                    <li>• <strong>Step 1:</strong> Primary Goal - Training focus and objectives</li>
                    <li>• <strong>Step 2:</strong> Experience - Sets program complexity level</li>
                    <li>• <strong>Step 3:</strong> Timeline - Influences periodization structure</li>
                    <li>• <strong>Step 4:</strong> Injury Screening - Safety and limitations</li>
                    <li>• <strong>Step 5:</strong> PHA Health Screen - Bryant Periodization safety</li>
                    <li>• <strong>Step 6:</strong> Gainer Type - Fiber type and rep optimization</li>
                    <li>• <strong>Step 7:</strong> SMART Goals - Specific measurable targets</li>
                    <li>• <strong>Step 8:</strong> Volume Landmarks - Current and target loads</li>
                    <li>• <strong>Step 9:</strong> System Recommendation - AI-powered program selection</li>
                </ul>
                <p className="text-gray-400 text-xs mt-3">Complete assessment for optimal program design</p>
            </div>
        </div>
    );
};
