        ...
        return (
            <div className="flex items-center justify-center p-8">
                <div className="text-center">
                    ...
                    <h3 className="text-lg font-medium text-white mb-2">Context Error</h3>
                    <p className="text-gray-400">Unable to load application context. Please refresh the page.</p>
        ...
        return (
            <div className="flex items-center justify-center p-8">
                <div className="text-center">
                    ...
                    <h3 className="text-lg font-medium text-white mb-2">Loading Context</h3>
                    <p className="text-gray-400">Please wait while the application initializes...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="space-y-6">
                ...
                {enhancedAssessment.smartGoals.validation && (
                    <div className={`rounded-lg p-4 border ${
                        enhancedAssessment.smartGoals.validation.isValid 
