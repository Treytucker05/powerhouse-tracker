...
describe('rounding utilities', () => {
  ...
  it('handles alias modes', () => {
    expect(roundToIncrement(177.2, 2.5, 'ceil')).toBe(180);
    expect(roundToIncrement(177.2, 2.5, 'up')).toBe(180);
    expect(roundToIncrement(177.2, 2.5, 'down')).toBe(175); // 70.88 -> floor 70 * 2.5? Wait floor(70.88)=70 -> 175
  });
